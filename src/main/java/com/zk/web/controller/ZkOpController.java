...
import com.zk.op.ClientCacheManager;
import com.zk.op.Zk;
...
public class ZkOpController {
	...
	public String create(Model model, String parent, String name, String data) throws Exception {
		...
		Zk zk = ClientCacheManager.getZk(cxnstr);
	...
	@RequestMapping("/edit")
	public String edit(Model model, String path, String data) throws Exception{
		String cxnstr = getCxnstr();
		if (StringUtils.isBlank(cxnstr)) {
			return "redirect:/";
		}
	...
	public String delete(Model model, String path, String data) throws Exception{
		String cxnstr = getCxnstr();
		if (StringUtils.isBlank(cxnstr)) {
			return "redirect:/";
		}
	...
	public String rmrdel(Model model, String path, String data) throws Exception{
		String cxnstr = getCxnstr();
		if (StringUtils.isBlank(cxnstr)) {
			return "redirect:/";
		}
